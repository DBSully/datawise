  ...
  return (
    <section className="dw-section-stack-compact">
      <div>
        ...
        <h1 className="dw-page-title">Wholesale Analysis</h1>
        <p className="dw-page-copy">
          Dedicated wholesale analysis workspace for{" "}
      ...
      <div className="dw-card">
        ...
        <div className="mt-2 text-sm text-slate-600">
          This page will become the wholesale strategy workspace, including
          assignment fee assumptions, buyer-side pricing, and disposition notes.
        </div>
      </div>
    </section>
  );
