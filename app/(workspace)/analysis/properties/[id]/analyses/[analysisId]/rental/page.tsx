  ...
  return (
    <section className="dw-section-stack-compact">
      <div>
        ...
        <h1 className="dw-page-title">Rental Analysis</h1>
        <p className="dw-page-copy">
          Dedicated rental analysis workspace for{" "}
      ...
      <div className="dw-card">
        ...
        <div className="mt-2 text-sm text-slate-600">
          This page will become the rental underwriting workspace, including
          rent assumptions, expenses, vacancy, management, and return metrics.
        </div>
      </div>
    </section>
  );
