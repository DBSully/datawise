...
export default async function NewBuildPage({ params }: NewBuildPageProps) {
  ...
  return (
    <section className="dw-section-stack-compact">
      <div>
        ...
        <h1 className="dw-page-title">New Build Analysis</h1>
        <p className="dw-page-copy">
          Dedicated infill / scrape / new-build workspace for{" "}
      ...
      <div className="dw-card">
        ...
        <div className="mt-2 text-sm text-slate-600">
          This page will become the new-build strategy workspace, including lot
          potential, redevelopment assumptions, and scrape / rebuild decision
          logic.
        </div>
      </div>
    </section>
